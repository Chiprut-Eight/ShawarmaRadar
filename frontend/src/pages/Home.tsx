      ...
      {activeInfo === 'ai' && (
        <div className="modal-overlay" onClick={() => setActiveInfo(null)}>
          <div className="modal-content" onClick={e => e.stopPropagation()}>
            ...
            <p>
              <strong>ומה הופך את הרדאר ל"חי"?</strong> כאן נכנס לפעולה המנוע הייחודי שלנו,<br/>הוא סורק מסביב לשעון את הרשתות החברתיות (טיקטוק, אינסטגרם, פייסבוק וביקורות אחרונות) וקורא את הסנטימנט העכשווי.
            </p>
            <p>
              המערכת מבינה סיטואציות כמו התלהבות מטורפת השבוע או תלונות טריות מקמפיין שלילי. הדיבור הזה משוקלל כ"בונוס" או כ"קנס" לדירוג הבסיסי ההיסטורי, וכך הרדאר מרים מקומות ש'חמים' הרגע, ומוריד מקומות שאכזבו הבוקר.
            </p>
